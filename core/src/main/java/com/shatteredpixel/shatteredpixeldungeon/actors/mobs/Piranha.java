...
public class Piranha extends Mob {
	...
	public Piranha() {
		...
		HP = HT = 10 + Dungeon.effectiveDepth() * 5;
		defenseSkill = 10 + Dungeon.effectiveDepth() * 2;
	}
	...
	public int damageRoll() {
		return Random.NormalIntRange( Dungeon.effectiveDepth(), 4 + Dungeon.effectiveDepth() * 2 );
	}
	
	@Override
	public int attackSkill( Char target ) {
		return 20 + Dungeon.effectiveDepth() * 2;
	}
	
	@Override
	public int drRoll() {
		return Random.NormalIntRange(0, Dungeon.effectiveDepth());
	}
